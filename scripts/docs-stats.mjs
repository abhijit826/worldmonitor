...
function computeStats({ sourceAttribution: computedSourceAttribution } = {}) {
  ...
  const sourceAttribution = computedSourceAttribution ?? buildSourceAttributionStats({ rootDir: rootOf() });
